...
const formSchema = z.object({
  ...
  linked_to_law_enforcement: z
    .enum(["Yes", "No", "Unsure", "Prefer not to say"])
    .optional(),
...
const universities = [
  ...
  {
    value: "Embry - Riddle International University",
    label: "Embry - Riddle International University",
  },
  {
  ...
  {
    value: "Washington University St. Louis",
    label: "Washington University St. Louis",
  },
...
const terminationReasons = [
  {
    id: "ina-237-a-1-c-i",
    label:
      "INA 237(a)(1)(C)(i) (Failure to maintain status/comply with conditions)",
  },
  {
    id: "ina-237-a-4-c-i",
    label: "INA 237(a)(4)(C)(i) (Serious adverse foreign policy consequences)",
  },
  {
    id: "criminal-records-check",
    label: "Criminal Records Check (General mention)",
  },
  {
    id: "specific-criminal-activity",
    label: "Specific Criminal Activity Cited (e.g., DUI, Theft, Assault)",
  },
  ...
  {
    id: "no-termination",
    label: "No Termination Yet (but received visa revocation)",
  },
];
...
const immediatePlans = [
  {
    id: "reinstatement",
    label: "Applying for SEVIS Reinstatement (Form I-539)",
  },
  { id: "litigation", label: "Exploring Litigation Options with Attorney" },
  { id: "depart", label: "Planning to Depart the U.S." },
  {
    id: "transfer",
    label: "Seeking Transfer to Another School (if applicable/possible)",
  },
...
export default function FormPage() {
  ...
  async function onSubmit(data: FormValues) {
    ...
    try {
      ...
      const finalData = {
        ...data,
        sevis_termination_date: data.sevis_termination_date
          ? data.sevis_termination_date.toISOString()
          : null,
        visa_revocation_date: data.visa_revocation_date
          ? data.visa_revocation_date.toISOString()
          : null,
      };
      ...
      <div className="container mx-auto px-4 py-12">
        <Card className="max-w-2xl mx-auto">
          <CardHeader>
            ...
            <CardDescription>
              Your information has been recorded anonymously and will help build
          ...
          <CardContent>
            <Alert className="bg-green-50">
              ...
              <AlertDescription>
                You will be redirected to the dashboard shortly to view
                aggregated data.
              </AlertDescription>
            </Alert>
          </CardContent>
      ...
      <div className="max-w-3xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold tracking-tight mb-2">
            F-1 Student Data Collection Form
          </h1>
          <p className="text-muted-foreground">
            Please provide information about your experience with SEVIS
            termination or F-1 visa revocation. All submissions are anonymous
            and will only be used for aggregated data analysis.
          </p>
        </div>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Please provide your .edu email address. This helps us prevent
                  duplicate submissions and will not be shared.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <FormField
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Please select your university or institution.
                </CardDescription>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Information about your SEVIS record status.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="space-y-3">
                      <FormLabel>
                        Has your SEVIS record been terminated?
                      </FormLabel>
                      <FormControl>
                        <RadioGroup
                ...
                {(watchSevisTerminated === "Yes" ||
                  watchSevisTerminated === "Unsure") && (
                  <>
                    <FormField
                      control={form.control}
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-col">
                          <FormLabel>
                            Approximate Date of SEVIS Termination
                          </FormLabel>
                          <Popover>
                            <PopoverTrigger asChild>
                              <FormControl>
                          ...
                          <FormDescription>
                            Month/Year required, Day optional
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>
                            How were you notified of the SEVIS termination?
                          </FormLabel>
                          <Select
                            onValueChange={field.onChange}
                            defaultValue={field.value}
                          >
                            ...
                            <SelectContent>
                              <SelectItem value="Email from DSO">
                                Email from DSO
                              </SelectItem>
                              <SelectItem value="Checked SEVP Portal">
                                Checked SEVP Portal
                              </SelectItem>
                              <SelectItem value="Notified by Attorney">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Information about your F-1 visa status.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="space-y-3">
                      <FormLabel>
                        Did you receive notification that your F-1 visa was
                        revoked by the Dept. of State?
                      </FormLabel>
                      <FormControl>
                        <RadioGroup
                          onValueChange={field.onChange}
                ...
                {watchVisaRevoked === "Yes" && (
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-col">
                        <FormLabel>
                          Approximate Date of Visa Revocation Notification
                        </FormLabel>
                        <Popover>
                          <PopoverTrigger asChild>
                            <FormControl>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Your F-1 status when the termination or revocation occurred.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        >
                          ...
                          <SelectContent>
                            <SelectItem value="Undergraduate - Year 1">
                              Undergraduate - Year 1
                            </SelectItem>
                            <SelectItem value="Undergraduate - Year 2">
                              Undergraduate - Year 2
                            </SelectItem>
                            <SelectItem value="Undergraduate - Year 3">
                              Undergraduate - Year 3
                            </SelectItem>
                            <SelectItem value="Undergraduate - Year 4+">
                              Undergraduate - Year 4+
                            </SelectItem>
                            <SelectItem value="Master's - Year 1">
                              Master's - Year 1
                            </SelectItem>
                            <SelectItem value="Master's - Year 2+">
                              Master's - Year 2+
                            </SelectItem>
                            <SelectItem value="PhD - Year 1">
                              PhD - Year 1
                            </SelectItem>
                            <SelectItem value="PhD - Year 2">
                              PhD - Year 2
                            </SelectItem>
                            <SelectItem value="PhD - Year 3">
                              PhD - Year 3
                            </SelectItem>
                            <SelectItem value="PhD - Year 4">
                              PhD - Year 4
                            </SelectItem>
                            <SelectItem value="PhD - Year 5+">
                              PhD - Year 5+
                            </SelectItem>
                            <SelectItem value="Language Training">
                              Language Training
                            </SelectItem>
                            <SelectItem value="Other">Other</SelectItem>
                          </SelectContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  If known, select the reason(s) provided for the termination or
                  revocation.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        This information will only be used for aggregation
                        purposes.
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Optional information about any related incidents.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="space-y-3">
                      <FormLabel>
                        Was the termination/revocation potentially linked to a
                        past interaction with law enforcement?
                      </FormLabel>
                      <FormControl>
                        <RadioGroup
                          onValueChange={field.onChange}
                  ...
                  <>
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>
                            Type of Incident (Select primary, if known)
                          </FormLabel>
                          <Select
                            onValueChange={field.onChange}
                            defaultValue={field.value}
                          >
                            ...
                            <SelectContent>
                              ...
                              <SelectItem value="Drug-related">
                                Drug-related (e.g., possession)
                              </SelectItem>
                              <SelectItem value="Theft/Shoplifting">
                                Theft/Shoplifting
                              </SelectItem>
                              <SelectItem value="Assault">Assault</SelectItem>
                              <SelectItem value="Trespass">Trespass</SelectItem>
                              <SelectItem value="Domestic Incident">
                                Domestic Incident
                              </SelectItem>
                              <SelectItem value="Public Intoxication">
                                Public Intoxication
                              </SelectItem>
                              <SelectItem value="Protest-related Arrest">
                                Protest-related Arrest
                              </SelectItem>
                              <SelectItem value="Other Minor Offense">
                                Other Minor Offense
                              </SelectItem>
                              <SelectItem value="Other Felony Charge">
                                Other Felony Charge
                              </SelectItem>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="space-y-3">
                          <FormLabel>
                            Were you fingerprinted related to this incident?
                          </FormLabel>
                          <FormControl>
                            <RadioGroup
                              onValueChange={field.onChange}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>
                            Current Status of that Legal Case
                          </FormLabel>
                          <Select
                            onValueChange={field.onChange}
                            defaultValue={field.value}
                          >
                            ...
                            <SelectContent>
                              ...
                              <SelectItem value="Convicted (Misdemeanor)">
                                Convicted (Misdemeanor)
                              </SelectItem>
                              <SelectItem value="Convicted (Felony)">
                                Convicted (Felony)
                              </SelectItem>
                              <SelectItem value="Expunged/Sealed">
                                Expunged/Sealed
                              </SelectItem>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  H1B status, legal consultation, and immediate plans.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        H1B Lottery Status (Current Fiscal Year - 2025 Lottery)
                      </FormLabel>
                      <Select
                        onValueChange={field.onChange}
                        defaultValue={field.value}
                      >
                        ...
                        <SelectContent>
                          <SelectItem value="Selected in Lottery">
                            Selected in Lottery
                          </SelectItem>
                          <SelectItem value="Not Selected">
                            Not Selected
                          </SelectItem>
                          <SelectItem value="Did Not Apply / Not Eligible">
                            Did Not Apply / Not Eligible
                          </SelectItem>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Please review and provide consent for data sharing.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                      ...
                      <div className="space-y-1 leading-none">
                        <FormLabel>
                          I consent to share anonymized, aggregated data trends
                          publicly
                        </FormLabel>
                        <FormDescription>
                          Your individual submission will remain anonymous. Only
                          aggregated trends and statistics will be shared.
                        </FormDescription>
                      </div>
                    </FormItem>
                  )}
      ...
      <Dialog open={showDuplicateDialog} onOpenChange={setShowDuplicateDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              An entry with this email already exists in our database. Would you
              like to overwrite the existing data?
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button
