...
interface LegalConsultationChartProps {
  data: {
    name: string
    count: number
  }[]
...
export function LegalConsultationChart({ data }: LegalConsultationChartProps) {
  ...
  try {
    ...
    console.error("Error rendering LegalConsultationChart:", error)
    return (
      <div className="flex h-full w-full items-center justify-center">
