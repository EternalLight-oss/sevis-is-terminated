...
interface FingerprintingChartProps {
  data: {
    name: string
    count: number
  }[]
...
export function FingerprintingChart({ data }: FingerprintingChartProps) {
  ...
  try {
    ...
    console.error("Error rendering FingerprintingChart:", error)
    return (
      <div className="flex h-full w-full items-center justify-center">
